"""
This is an animal quiz i made for a school project.
It asks 14 questions about animals
shows score,
asks user if they want to know answers,
...
#runs the program that was defined in main function
main()
